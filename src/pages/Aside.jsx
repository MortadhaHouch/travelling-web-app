...
export default function Aside(props) {
    ...
    return (
        <main className="d-flex flex-column justify-content-start align-items-center">
            <ul className={`nav nav-tabs aside ${isShown?"shown":""}`} role="tablist">
                <button className="btn btn-info tooltip-arrow" onClick={()=>setIsShown(!isShown)}>
                    {
                        isShown?(
            ...
            <section className="tab-content w-100 h-100">
                {
                    componentName =="users" && 
                    <Users 
                ...
                }
                {
                    componentName == "posted-feedbacks" && (
                        <section
                            className="tab-pane d-flex flex-column justify-content-start align-items-center feedback-cards-container p-3"
                            id="posted-feedbacks"
                            role="tabpanel"
